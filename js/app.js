...
function setUrlParam(e, t) {
  ...
  if (a.test(r))
    i =
      null != t
        ? r.replace(a, "$1" + e + "=" + t + "$2$3")
        : ((r = (n = r.split("#"))[0]
            .replace(a, "$1$3")
            .replace(/(&|\?)$/, "")),
          void 0 !== n[1] && null !== n[1] && (r += "#" + n[1]),
          r);
  else if (null != t) {
    var o = -1 !== r.indexOf("?") ? "&" : "?";
    (r = (n = r.split("#"))[0] + o + e + "=" + t),
...
function toggleDomain(i, r) {
  getData(function (e) {
    var t,
      n = getIndex("id", e.sites, i);
    ~n && ((t = !e.sites[n].options.on), (e.sites[n].options.on = t)),
      saveAndCallBack(e, r(t));
  });
}
...
function Protos(e) {
  return (
    ...
    (this.data = {
      ...
      sites: [],
      libs: [{ name: "jQuery 3", src: "@extension@jquery.min.js" }, { name: "Vue @ 3.2.47", src: "@extension@vue.global.js" }],
    }),
    this[e]
  );
}
...
function getAndSort(e) {
  for (
    var t = Object.assign({ sites: [], items: {}, alt: !1 }, e),
      n = t.items,
      i = t.sites,
      r = { js: [], css: [], libs: [] },
      a = 0;
    ...
    if (o.options.on) {
      if (
        (o.js && o.options.altJS === t.alt && r.js.push(o.js),
        o.css && o.options.altCSS === t.alt)
      ) {
        var s = o.css;
        o.options.autoImportant &&
          (s =
            void 0 !== o.compiledCss
              ? o.compiledCss
              : cssApplyImportant(o.css)),
          r.css.push(s);
      }
      o.libs &&
        Array.isArray(o.libs) &&
        0 < o.libs.length &&
        o.options.altJS === t.alt &&
        r.libs.push(o.libs);
    }
  }
  if (0 < r.libs.length) {
    ...
    for (var b = [], v = 0; v < n.libs.length; v++) {
      ...
      if (~l.indexOf(m.src)) {
        var h = m.src;
        ~h.indexOf("@extension@") &&
          ((h = h.replace("@extension@", "")),
          (n.libs[v].src = chrome.runtime.getURL("js/libs/" + h))),
          b.push(m.src);
      }
    }
    r.libs = b;
...
function setScript(e, t, n) {
  ...
  i.setAttribute("data-source", "Insert JS & CSS - Santosh extension"),
    e && (i.src = e),
    2 < arguments.length && (i.innerHTML = n),
    (i.async = !1),
    t.appendChild(i);
}
function editLink(e) {
...
function strToPath(e, t, n) {
  return "string" == typeof t
    ? strToPath(e, t.split("."), n)
    : 1 === t.length && void 0 !== n
    ? (e[t[0]] = n)
    : 0 === t.length
    ? e
    : strToPath(e[t[0]], t.slice(1), n);
}
function cssApplyImportant(e) {
  for (
    var t,
      ...
      r =
        ...
        ((i = document.createElement("style")).textContent = t),
  ...
  function c(e) {
    ...
    return (
      ";" !== n.slice(-1) && (n += ";"),
      (n = (n = n.replace(/\!important/gi, "")).replace(t, "!important;")),
      e.selectorText + " {" + n + "}"
    );
  }
}
    ...
    for (var n in t)
      isObject(t[n])
        ? (e[n] || Object.assign(e, _defineProperty({}, n, {})),
          mergeDeep(e[n], t[n]))
        : Object.assign(e, _defineProperty({}, n, t[n]));
  return e;
}
function addEl(e, t, n) {
  var i = document.createElement(e);
  if (void 0 !== t) for (var r in t) i.setAttribute(r, t[r]);
...
function makeCheckBox() {
  ...
  return (
    ...
    '" ' +
    (void 0 === c ? "" : c) +
    '><div class="checkbox__indicator"></div></label>'
  );
}
...
function getSites(e, t) {
  ...
  for (
    var n = addEl("div", { class: "b-sites b-list" }), i = 0;
    i < e.length;
    i++
  ) {
    var r = getSite(e[i].id, e),
      ...
      l = r.name ? addEl("div", { class: "b-sites__name" }, r.name) : "",
      c = addEl("div", { class: "b-sites__url b-list__grow" }, r.id);
...
function addLibRow(e, t) {
  var n = addEl("div", { class: "b-libs__item b-list__item" });
  return (
    n.appendChild(addEl("div", { class: "b-libs__handle" })),
    n.appendChild(addEl("div", { class: "b-libs__name b-list__grow" }, e)),
    n.appendChild(
      addEl("input", { class: "b-libs__src", type: "text", value: t })
    ),
    n.appendChild(addEl("div", { class: "b-libs__remove delete" })),
    n
  );
}
function updateLibsList(a, o) {
  getData(function (e) {
    for (
      var t = addEl("div", { class: "b-libs b-list" }), n = 0;
      n < e.libs.length;
      n++
    ) {
      var i = e.libs[n],
...
function setEditor(e, t, n) {
  ...
  return (
    (r.wrap = !!r.wrap && "free"),
    (r.keyboardHandler = r.keyboardHandler ? "ace/keyboard/vim" : void 0),
    i.getSession().setMode("ace/mode/" + t),
    i.setOptions(r),
    i.renderer.setScrollMargin(0, a),
    (i.$blockScrolling = 1 / 0),
    i
  );
}
...
Array.prototype.findIndex ||
  (Array.prototype.findIndex = function (e) {
    ...
    for (
      var t, n = Object(this), i = n.length >>> 0, r = arguments[1], a = 0;
      a < i;
      a++
    )
    ...
    Object.defineProperty(Object, "assign", {
      ...
      value: function (e, t) {
        ...
        for (var n = Object(e), i = 1; i < arguments.length; i++) {
          ...
          if (null != r)
            for (
              var a = Object.keys(Object(r)), o = 0, s = a.length;
              o < s;
              o++
            ) {
              var l = a[o],
